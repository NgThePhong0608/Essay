...
%
% Template này có thể được download từ:
% ???????
%
...
\field{Ngành đào tạo} 						% Ví dụ: "Ngành Vật lý", "Ngành Hóa học", v.v.
...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace{-0.4cm}\Large \, \univname\\
		\vspace{-0.4cm}\Large \, \textbf{\deptname}\\[0.5cm]
